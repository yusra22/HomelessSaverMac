...
import com.uyr.yusara.homelesssavermac.Agency.EditMyAgencyPost;
        ...
        if(photo1 != null){
            ...
            filePath2.putBytes(b).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task3)
                {
                    ...
                    {
                        Toast.makeText(EditMyHomelessPost.this, "Camera 2 upload success", Toast.LENGTH_SHORT).show();
        ...
        if(photo2 != null){
            ...
            filePath3.putBytes(b).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task3)
                {
                    ...
                    if(task3.isSuccessful())
                    {
                        Toast.makeText(EditMyHomelessPost.this, "Camera 3 upload success", Toast.LENGTH_SHORT).show();
...
/*                                    HashMap postnotification = new HashMap();
    ...
    {
        startActivity(new Intent(this, Myhomelesspost.class));
        finish();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == TAKE_PICTURE1)
        {
            ...
            Toast.makeText(EditMyHomelessPost.this, "camera 2 Selected!", Toast.LENGTH_SHORT).show();
        ...
        if(requestCode == TAKE_PICTURE2)
        {
            ...
            Toast.makeText(EditMyHomelessPost.this, "camera 3 Selected!", Toast.LENGTH_SHORT).show();
